...
var worker = new bullmq_1.Worker('RegistrationMail', function (job) { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                error_1 = _a.sent();
                console.log(job.id + " falhou com o erro " + error_1);
                return [3 /*break*/, 3];
...
worker.on('drained', function (job) {
